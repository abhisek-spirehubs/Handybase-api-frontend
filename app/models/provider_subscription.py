...
class ProviderSubscription(LogBase):
    """
    A provider's active subscription to a provider plan.
    One active subscription per provider at a time.
    features_snapshot — copied from ProviderPlan.features at purchase time.
    """
    user_id:   str
    plan_id:   str                              # ProviderPlan._id
    plan_type: str                              # "provider_tier1" | "tier2" | "tier3"
